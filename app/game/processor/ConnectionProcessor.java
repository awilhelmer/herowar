...
/**
 * Abstract processor to keep web socket connection and provides basic
 * functionality.
 * 
...
public abstract class ConnectionProcessor extends AbstractProcessor {
  ...
  /**
   * Get user session from games handler. If this returns null the client has
   * already closed the connection.
   * 
   * @return GameSession
   */
  public GameSession getSession() {
    return GamesHandler.getInstance().getConnections().get(connection);
  }
