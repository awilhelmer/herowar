...
public class TutorialPlugin extends AbstractPlugin implements IPlugin {
  ...
  private String[][] texts = {
      ...
      { "On the top left cornor you will see your score,", "lives and gold. Its important to have allways", "lives left.", "",
          "It is possible to earn gold for killing creeps", "or on some maps you gain gold over time." },
      { "On the bottom left cornor you have access to", "the build menu so you can place new towers on", "the map.", "",
          "Depending on the mission you can choose", "between different towers. Each tower has its own", "unique abilities. Check the build menu tooltips for",
          "detailed informations." },
      { "Now lets check out the map. The enemies will", "try to pass the map on the grey path.", "", "Sometimes there is a wave indicator. So you",
          "see from which side the enemies will come." }, { "Ok its time to build your first tower. You", "should place it on strategic important points." } };
